...
through the lens to finely focus the image on the retina. (\todo[]{put light
path image})
...
of the macula.\cite{hendrickson1994primate} \todo{rod and cone density}
It is the most sensitive part of the eye so most cones are located directly
behind that point.\Fref{fig:cone} shows a schematic diagram of the cone cell.
