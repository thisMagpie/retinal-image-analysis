...
the cornea allows plenty of light to pass through, but refracts due to
 its convex, convergent lens shape. \Eref{eq:refractive} shows Snell's
...
\todo[inline]{diagram and equations here}
...
no longer being accommodated.\cite{}\fref{fig:cilary_processes} shows some key ciliary
processes. 
...
The retina is where light is changed from light waves into electrical signals which we call brainwaves.\todo{write stuff}
