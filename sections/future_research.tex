...
\begin{figure}[H]
\centering
\includegraphics[width=14cm]{figures/bluehazard}
...
the leaking from the vessels. 1E and 1F are spectral domain \Gls{oct} images which demonstrate foveal thinning and retinal damage.\cite{}}
\label{fig:mt}
\end{figure}
...
drusen in Bruch's membrane (the innermost layer of the choroid).\cite{}}
\label{fig:multi}
\end{figure}
...
\caption{A comparison of standard resolution fundus images with the capabilities of high resolution \Gls{ao} imaging.\cite{}}
\label{fig:ao}
\end{figure}
...
\caption{An example of Scale Invariant Feature Transform in retina matching.\cite{}}
\label{fig:sift}
\end{figure}
