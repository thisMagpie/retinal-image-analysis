...
As was mentioned in section 2, the illuminating and imaging beams cannot cross paths. This is dealt with in the fundus camera by illuminating a peripheral zone of the retina with a donut of light. \fref{fig:ld} 
...
donut area reflecting to form the imaging beam. A comparison between the illumination and imaging areas of a fundus camera (left image) and cSLO (right image) are shown in  \fref{fig:illum}.
...
Through the assimilation of several LASER systems the California
...
in \fref{fig:dr}, which ultimately develops into diabetic macular edema if
