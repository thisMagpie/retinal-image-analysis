...
The TRC-NW8F is an efficient, highly specified multi-function fundus camera that provides the clinician a variety of diagnostic tools, placing it at the forefront of modern retinal imaging. By incorporating lens filters this device is equipped for four imaging modes at a field of view of 45° with a built-in 30° digital zoom feature: colour fundus, red-free, fluorescein angiography and fundus auto-fluorescence, examples of each shown in \fref{fig:im}.
