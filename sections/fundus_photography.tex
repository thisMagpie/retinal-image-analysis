...
This pattern is achieved by passing the illuminating rays through
...
specifically at the Topcon TRC-NW8F retinal camera, shown in \fref{fig:trc}.
...
and \gls{cslo} (right image) are shown in  \fref{fig:illum}.
...
California ultra-wide-field \gls{cslo}, shown in \fref{fig:cali}.
...
\subsection{Fundus Autofluorescence}
...
\Fref{fig:uwfvs} displays the difference in the wide-field images these
devices can capture.
...
in \fref{fig:3d}. The accuracy of these images is significantly limited by the
