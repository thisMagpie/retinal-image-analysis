...
The opthalmoscope was reinvented again by von Helmholtz in 1851.  As with many
...
rays are focused on to the observer's retina, as shown in \fref{fig:direct_opthal}.
